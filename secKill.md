...
### 很惭愧当前项目仍处于本地建设阶段，无法上线直观展示，谨奉上论证文档供斧正，望海涵！
...
- 缓存的目标是什么？目标是读多写少且体积适合的数据，具体来说就是可见性公开的数据对象，高频分页的第一页，为什么可见性公开是因为可见性私有的只有作者偶尔访问缓存命中率低性价比低，在此基础上对象和列表的key固定命中率高，虽然总体上分页检索条件多变命中率低但默认条件的第一页是必经之路而且往往客户端只看第一页所以命中率高
